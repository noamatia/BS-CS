...
export const makeTuple = (ss: SExpValue[]): Value =>
    makeTupleHelper(first(ss), rest(ss));

export const makeTupleHelper = (f: SExpValue, r: SExpValue[]): Value =>
    isEmpty(r) ? makeCompoundSExp(f, makeEmptySExp()) :
    (makeCompoundSExp(f, makeTupleHelper(first(r), rest(r))));
